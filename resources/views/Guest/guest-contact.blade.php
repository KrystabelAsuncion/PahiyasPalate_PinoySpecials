...
<nav class="navbar navbar-expand-lg sticky-top" style="background: #f7b87e;">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        <ul class="navbar-nav nav-underline d-flex justify-content-sm-center" role="tablist">
            ...
            <!--contactTab-->
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('guest-contact') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="row mx-auto text-center p-4">
                                <div class="col justify-content-center">
                                    <a class="btn btn-outline-facebook text-center shadow" style="width: 25rem;">
                                ...
                                <div class="col justify-content-center">
                                    <button class="btn btn-outline-instagram text-center shadow" style="width: 25rem;">
                                ...
                                <div class="col justify-content-center">
                                    <button class="btn btn-outline-twitter text-center shadow" style="width: 25rem;">
