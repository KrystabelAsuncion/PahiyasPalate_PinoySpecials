        ...
        <div class="tab-pane active" id="UserTabPane" role="tabpanel" aria-labelledby="User-tab" tabindex="0">
            <div class="container d-flex justify-content-center">
                ...
                <div class="row my-4 align-items-center d-flex justify-content-center">
                    ...
                    <div class="col-lg-3 p-4 me-3 shadow" style=" border-radius: 20px; height: 450px;">
                        <div class="row justify-content-center">
                            @if(Auth::user()->profile_image)
                                <!-- If user has a profile image -->
                                <div class="row" style="width: 350px; height:250px;">
                                    <img src="{{ asset(Auth::user()->profile_image) }}" class="rounded-circle img-fluid" style="background-color: white; object-fit:cover;">
                                </div>
                            @else
                    ...
                    <div class="col-lg-6 mt-4">
                        ...
                        <div class="row shadow p-4 fs-2" style="width: 700px; border-radius: 20px;">
